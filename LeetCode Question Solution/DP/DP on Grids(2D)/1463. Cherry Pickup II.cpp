...
class Solution {
public:
    int ans(int i, int j1, int j2, vector<vector<int>>& grid) {
        ...
        for(int dj1=-1;dj1<2;dj1++) {
            for(int dj2=-1;dj2<2;dj2++) {
                ...
                value+=ans(i+1,j1+dj1,j2+dj2,grid);
                maxi=max(maxi,value);
            }
        }
        return maxi;
    ...
    int ans(int i, int j1, int j2, vector<vector<int>>& grid, vector<vector<vector<int>>> dp) {
        ...
        for(int dj1=-1;dj1<2;dj1++) {
            for(int dj2=-1;dj2<2;dj2++) {
                ...
                value+=ans(i+1,j1+dj1,j2+dj2,grid,dp);
                maxi=max(maxi,value);
            }
        }
